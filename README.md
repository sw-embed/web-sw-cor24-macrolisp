...
- **34 embedded demos**: TCO, macros, lazy sequences, error handling, anaphoric macros, bottles of beer, LED blink, infix/fuzzy/percent-tolerance DSLs, reduce patterns, tail-recursive power, glyph-notation power DSL, and more — grouped by prelude in the dropdown
